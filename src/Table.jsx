  ...
  function sortData(data, option) {
    ...
    switch (option) {
      ...
      case 'price-increase':
        ...
        break;
      case 'deviation':
        sortedData = [...data].sort((a, b) => Math.abs(a.priceDeviation) - Math.abs(b.priceDeviation));
        break;
      case 'date':
        sortedData = [...data].sort((a, b) => new Date(b.publicationDate) - new Date(a.publicationDate));
        break;
      default:
        sortedData = data;
    }
